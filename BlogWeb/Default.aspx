...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="Dosyalar/img/faviconexm.png">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#interests">Hobi</a>
                </li>
                <li class="nav-item">
            ...
            <div class="my-auto">
                ...
                <asp:Repeater ID="Repeater6" runat="server">
                    <ItemTemplate>
                        <ul class="fa-ul mb-0">
                            <li>
                                <i class="fa-li fa fa-circle text-info"></i>
            ...
            <div class="my-auto">
                ...
                <asp:Repeater ID="Repeater5" runat="server">
                    <ItemTemplate>
                        <ul class="fa-ul mb-0">
                            <li>
                                <i class="fa-li fa fa-certificate text-info"></i>
